...
static sgx_status_t SGX_CDECL Enclave_ocall_set_active_to_false(void* pms)
{
	ms_ocall_set_active_to_false_t* ms = SGX_CAST(ms_ocall_set_active_to_false_t*, pms);
	ocall_set_active_to_false(ms->ms_message);
...
static const struct {
	...
	10,
	{
		...
		(void*)(uintptr_t)Enclave_ocall_set_active_to_false,
